#ifndef __GL_TEXTURE_PROGRAM__
#define __GL_TEXTURE_PROGRAM__
...
class GLTextureProgram : public TextureProgram
{
private:
    char *imagePath;
    int width, height;
...
public:
    GLTextureProgram(const char *inImagePath, unsigned int TileSize, Vec2f flip);
    ~GLTextureProgram();
